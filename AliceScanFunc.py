#These are the functions you need to load in order to remotely
# control Alice's power supply.
...
def InitiateResource():
    ...
    resourceName="USB0::65535::37168::602361010736720006::0::INSTR" #Visa name of power supply
